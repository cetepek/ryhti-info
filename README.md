...
Jos sovelluksessa on ongelma tai kysyttävää, [avaa issue tähän repoon](https://github.com/cetepek/ryhti-info/issues).

If you run into a problem with the app or have a question, please [open an issue on this repo](https://github.com/cetepek/ryhti-info/issues).
...
Kysymykset tietosuojasta voi esittää [avaamalla issuen tähän repoon](https://github.com/cetepek/ryhti-info/issues).

Privacy-related questions can be raised by [opening an issue on this repo](https://github.com/cetepek/ryhti-info/issues).
